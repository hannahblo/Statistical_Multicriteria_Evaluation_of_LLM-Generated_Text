...
strategy_comparison <- list("beam_search",
                            "contrastive_search",
...
# Load the data set
data_all <- read_excel("datasets/translation_dataset.xlsx")
data_all <- data_all[, c(4,5,6,7)]
...
plotting_permutationtest_translation(results_plots)
